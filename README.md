...
- **Magnetic Snap**: 마그네틱 스크롤 스냅으로 씬 겹침 현상 완전 해결
- **Brand Separation**: Leros(기업)와 프로젝트(무지개숲)의 정체성 분리
...
- Vanilla JavaScript (Scroll Observer, Magnetic Snap)
...
- **마그네틱 스크롤 스냅**: 씬 겹침 없는 깔끔한 전환
- **글래스 알약 버튼**: "Origin ↑" 상시 노출
- **모바일 하단 네비게이션**: 가로형 알약 스타일
- **프로젝트 진열장**: 향후 확장 가능한 그리드 레이아웃
- **5개 씬 구조**: Home, Philosophy, Values, Projects, Contact
